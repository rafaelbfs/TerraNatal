...
{
    [Table("admin_user", Schema = "finance")]
    public partial class AdminUser
    {
        ...
        [Column("ADMIN_CLEARANCE")]
        [StringLength(15)]
        public string AdminClearance { get; set; }
        [Column("ADMIN_CLEARANCE_LEVEL")]
        public int? AdminClearanceLevel { get; set; }
    }
}
